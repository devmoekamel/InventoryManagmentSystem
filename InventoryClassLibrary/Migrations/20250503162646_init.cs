...
namespace InventoryClassLibrary.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LowStockLogs_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LowStockLogs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Transactions_Warehouses_FromWarehouseId",
                        column: x => x.FromWarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transactions_Warehouses_ToWarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LowStockLogs_CreatedBy",
                table: "LowStockLogs",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_LowStockLogs_ProductId",
                table: "LowStockLogs",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_FromWarehouseId",
                table: "Transactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ToWarehouseId",
                table: "Transactions",
